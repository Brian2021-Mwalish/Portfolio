              ...
              <div className="flex-1">
                ...
                <div className="bg-yellow-100 dark:bg-yellow-900/60 rounded-xl px-4 py-3 mb-4">
                  <p className="text-lg font-semibold text-blue-900 dark:text-yellow-100 mb-2">
                    I have collaborated with multiple engineers on the development of appapplications and platforms across business, booking, institutional, and SME domains. Activities include:
                  </p>
