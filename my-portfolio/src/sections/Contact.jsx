...
const Contact = () => {
  // No form state needed for mailto
  const sectionRef = useRef(null);
  const isInView = useInView(sectionRef, { once: true, margin: "-100px" });

  const handleInputChange = (e) => {
    // No-op: removed for mailto
  };
          ...
          <motion.div variants={itemVariants}>
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl hover:scale-105 transition-transform duration-300">
              <h3 className="text-2xl font-bold text-primary-text mb-6">Send Me a Message</h3>
                ...
                <a
                  href="mailto:brianmwalish@gmail.com"
                  className="w-full block py-4 px-6 rounded-xl font-semibold transition-all duration-300 text-center bg-blue-500 text-white hover:bg-blue-600"
                >
                  Send Email
                </a>
            </div>
